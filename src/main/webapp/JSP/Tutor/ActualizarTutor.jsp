...
<html>
    ...
    <body>
        <div class="row justify-content-center">
            ...
            <!--Formulario Actualiza Tutor-->
            <form action ="AvatarUsuario" method="POST" enctype="multipart/form-data"> 
                <div class="modal-body">
                    ...
                    <div id="boton" class="modal-footer text-left">
                        <input type="submit" value="actualizar" id="registrar" class="btn btn-primary" data-dismiss="modal" name="Actualizar"> 
                    </div>
